#!/usr/bin/env python3
"""
V535 — Submission with V534 BEST config
- Config: Q1_n3, Q2_n10, Q3_n7, S1_n3, S2_n7, S3_n23, S4_n20
- Meta: Ridge (α=0.01)
- Expected avg_gap: -0.02824
- Expected LB: ~0.65059
"""
...
def main():
    t_start = time.time()
    log.info("=" * 70)
    log.info("V535 — Submission (V534 BEST config)")
    log.info("=" * 70)
    log.info("Config: Q1_n3, Q2_n10, Q3_n7, S1_n3, S2_n7, S3_n23, S4_n20")
    log.info("Meta: Ridge (α=0.01)")
    log.info("Expected avg_gap: -0.02824, Expected LB: ~0.65059")
    ...
    for target in TARGETS:
        ...
        log.info(f"  {target}: n_feat={bc['n_feat']}, wx={wx:.3f}")

    # Compute gaps with Ridge α=0.01
    ...
    log.info(f"\n  avg_gap: {avg_gap:.5f}, vs308: {vs308}/7")
    ...
    sub_path = SUBMIT / f'submission_v535_q1n3_q2n10_s4n20_Ridge01_{ts}.csv'
    ...
    result = {
        'version': 'V535',
        'name': 'Submission (V534 BEST config)',
    ...
    result_path = EXPERIMENTS / f'v535_{result["timestamp"]}.json'
